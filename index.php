...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-7">
            <h2 class="fs-title tittre"> TUP-transfrontalière pour SAS: Formualaire à remplir </h2> 
                <div class="form-group">
                    <select class="form-control societe" name="societe" id="test" placeholder="test">
                    <option value="">Votre société est une</option>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="date" id="date" placeholder="Date d'assemblée extraordinaire" onfocus="(this.type='date')" required /><br/>
                </div>
                <div class="form-group">
                    <button type="button" id="choisir" class="valider" name="continuer"> Valider <img src="ajaxloader.gif" alt="chargement" id="chgt"> </button>
                </div>
