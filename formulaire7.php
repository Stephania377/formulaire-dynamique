            ...
            <form action="test.php" method="post">
                <div class="form-group">
                    <div class="wpb_wrapper" style="text-align: center;">
                        <p class="titreb">A PROPOS DE LA SOCIETE HOLDING ABSORBANTE</p>
                    </div>
                    ...
                    <input type="text" class="form-control" name="pays" id="pays" placeholder="Pays" required /> <br/>
                    <input type="text" class="form-control" name="num" id="num" placeholder="Numéro d'immatriculation" required /> <br/>
                    <input type="number" class="form-control" name="passif" id="passif" placeholder="Montant de l’actif de la société au jour du PV d’assemblée :" required /> <br/>
                    <input type="number" class="form-control" name="actif" id="actif" placeholder="Montant du passif de la société au jour du PV d’assemblée :" required /> <br/>
...
if(isset($_POST['continuer'])){
    $_SESSION['passif'] = $_POST['nom'];
    $_SESSION['actif'] = $_POST['capitale'];
