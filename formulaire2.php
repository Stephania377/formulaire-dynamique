            ...
            <form action="" method="post">
                <div class="form-group">
                    <div class="wpb_wrapper" style="text-align: center;">
                        <p class="titreb">A PROPOS DU PRESIDENT</p>
                    </div>
                ...
                <button type="submit" id="choisir" class="valider" name="continue"> Valider <img src="ajaxloader.gif" alt="chargement" id="chgt"> </button>
            </form>
        </div>
</div>
...
if(isset($_POST['continue'])){
    ...
    $_SESSION['adrc'] = $_POST['adr'];
    $_SESSION['codec'] = $_POST['code'];
    $_SESSION['villec'] = $_POST['ville'];
    $_SESSION['villenc'] = $_POST['villen'];
    $_SESSION['datec'] = $_POST['date'];
    $_SESSION['paysnc'] = $_POST['paysn'];
    $_SESSION['natc'] = $_POST['nat'];
...
<style>
  ...
  #imgbg{
    background-image: url("ordi2.jpeg");background-color:#ff5300;
    color: #ffffff;
  }
  </style>