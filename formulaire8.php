            ...
            <form action="test.php" method="post">
                <div class="form-group">
                    ...
                    <div class="wpb_wrapper" style="text-align: center;">
                        <p class="titreb">A PROPOS DU REPRESENTANT DE LA SOCIETE HOLDING ABSORBANTE</p>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="prenom" id="prenom" placeholder="Prénom"  /><br/>
                    <input type="text" class="form-control" name="adr" id="adr" placeholder="Adresse" /><br/>
                    <input type="number" class="form-control" name="code" id="code" placeholder="Code postal"  /> <br/>
                    <input type="text" class="form-control" name="ville" id="ville" placeholder="Ville"  /> <br/>
                    <input type="text" class="form-control" name="date" id="date" placeholder="Date de naissance" onfocus="(this.type='date')"  /><br/>
                    <input type="text" class="form-control" name="villen" id="villen" placeholder="Ville de naissance"  /> <br/>
                    <input type="text" class="form-control" name="paysn" id="paysn" placeholder="Pays de naissance"  /> <br/>
                    <input type="text" class="form-control" name="nat" id="nat" placeholder="Nationalité"  /> <br/>
...
if(isset($_POST['continuer'])){
    ...
    $_SESSION['capitale'] = $_POST['capitale'];
    $_SESSION['nb'] = $_POST['nb'];
    $_SESSION['mtt'] = $_POST['mtt'];
