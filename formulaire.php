            ...
            <form action="" method="post">
                <div class="form-group">
                    <div class="wpb_wrapper" style="text-align: center;">
                        <p class="titreb">A PROPOS DE LA SOCIETE</p>
                    </div>
            
                                    <input type="text" class="form-control" name="nom"  id="nom" placeholder="Nom de votre société" required /><br/>
                                    <input type="number" class="form-control" name="capitale" id="capitale" placeholder="Capitale sociale" required /><br/>
                                    <input type="number" class="form-control" name="nb" id="nb" placeholder="Nombre de parts sociales" required/><br/>
                                    <input type="number" class="form-control" name="mtt" id="mtt" placeholder="Montant d'une part sociale" required /> <br/>
                                    <input type="text" class="form-control" name="act" id="act" placeholder="Activité exacte" required /> <br/>
                                    ...
                                    <input type="text" class="form-control" name="siren" id="siren" placeholder="SIREN" required /> <br/>
                                    <input type="text" class="form-control" name="num" id="num" placeholder="Numéro RCS" required /> <br/>
